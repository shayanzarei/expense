...
export function SupabaseConfigBanner() {
  return (
    <div className="mx-4 mt-4 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-950">
      <p className="font-semibold">Supabase not configured on this deploy</p>
      {supabaseConfigError && (
        <p className="mt-2 rounded-lg bg-amber-100/80 px-2 py-1.5 font-mono text-[11px] leading-relaxed">
          {supabaseConfigError}
        </p>
      )}
